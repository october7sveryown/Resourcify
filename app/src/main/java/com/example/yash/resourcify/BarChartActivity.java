...
public class BarChartActivity extends Activity {
    ...
    public String transactiondate,URL;
    public Date final1;
    public float Purchase,Sales;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        URL ="http://192.168.12.52:34/MyTaskManager/v1/getBoth";
        try {
        ...
        SalesPurchaseRequest(URL);
        setData();
        typeface=Typeface.createFromAsset(getAssets(),"fonts/RobotoCondensed-Italic.ttf");
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                barChart.saveToGallery("mpandroidchart-both",View.DRAWING_CACHE_QUALITY_HIGH);
    ...
    void SalesPurchaseRequest(String url){
            ...
            case "fals":
                ...
                try {
                    ...
                    for (int i = 0; i < n; i++) {
                        ...
                        Transactions transactions=new Transactions(i,Sales,Purchase,final1,transactiondate);
    ...
    private void setData(){
        ...
        RealmResults<Transactions> results = realm.where(Transactions.class).greaterThanOrEqualTo("mydate",StartDate).lessThanOrEqualTo("mydate",EndDate).findAll();
        RealmBarDataSet<Transactions> barDataSet = new RealmBarDataSet<Transactions>(results, "Purchase_order", "id");
        RealmBarDataSet<Transactions> barDataSet1 = new RealmBarDataSet<Transactions>(results, "Sales_order", "id");
        barDataSet1.setColor(ColorTemplate.rgb("#8e44ad"));
        barDataSet1.setLabel("Sales Order");
        barDataSet1.setValueFormatter(new MyCustomFormatter());
